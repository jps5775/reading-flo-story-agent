...
class AgentAudioMaker:
    ...
    def create_audio(self, story_path: str, story_id: str, directory_path: str) -> AudioGenerationResult:
        """
        ...
        try:
            ...
            for language_code in self.voice_configs:
                for gender in self.voice_configs[language_code]:
                    ...
                    voice_result = self._generate_voice_audio(ssml_text, story_id, directory_path, language_code, gender)
                    if voice_result:
            ...
            print(f"✓ Audio generation completed: {len(voice_results)}/4 voices generated")
    ...
    def _generate_voice_audio(self, ssml_text: str, story_id: str, directory_path: str, language_code: str, gender: str) -> Optional[VoiceAudioResult]:
        try:
