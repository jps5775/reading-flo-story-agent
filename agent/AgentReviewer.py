...
class AgentReviewer:
    ...
    def _provide_feedback(self, story: str, level: str) -> ReviewAssessment:
        ...
        **Story to Review**: {story}
        ...
        When reviewing a story, you will be provided with the story text. You must:
    ...
    def _modify_story(self, story: str, level: str, assessment: ReviewAssessment) -> StoryRevision:
        ...
        **Action Needed**: {assessment.action_needed}
        ...
        You are an expert Spanish language educator and story editor. Based on the comprehensive assessment provided, revise the story to address all identified issues while maintaining the original story's intent, style, and engagement.
